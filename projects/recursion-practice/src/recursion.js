...
var capitalizeWords = function(input) {
  ...
  // recursive
  let capitalizedWords = capitalizeWords(input.slice(1));
  capitalizedWords.unshift(word);
...
var capitalizeFirst = function(array) {
  ...
  return [firstWordCapitalized, ...capitalizeFirst(array.slice(1))];
};
...
var minimizeZeroes = function(array) {
  ...
  return [...minimizeZeroes(array.slice(0, index - count)), 0, ...minimizeZeroes(array.slice(index))];
};
